   ...
   <!--nav1 B-->
    ...
    <div class="container" style="height: 1500px;">
      ...
      <div class="container_bottom">
        <form action="savezhiwei" style="width: 600px;">
        <input type="hidden" value="${sessionScope.compan.get(0).company_id}" name="company_id" />
          <ul>
            <li>
              ...
              <input type="text" placeholder="请输入职位名称，如：web前端开发" name="need_name">
            </li>
            <li>
              <h1 style="float: left;margin-top: 10px">工作城市</h1>
              <input type="text" placeholder="例：北京" style="width: 200px; margin-left:148px" name="need_city">
            </li>
            <li style="border-bottom: 1px dashed gray;width: 478px"></li>
            <li>
              <h1>月薪范围</h1>
              <input type="text" id="ipt" placeholder="请选择月薪范围" name="need_money">
              <ul id="money">
                <li>2k以下</li>
                <li>2k-5k</li>
                <li>5k-10k</li>
            ...
            <li>
              <h1>工作经验</h1>
              <input type="text" id="exp" placeholder="请选择工作经验" name="need_jingyan">
              <ul id="exps">
                <li>不限</li>
                <li>应届毕业生</li>
                <li>1年以下</li>
            ...
            <li>
              <h1>学历要求</h1>
              <input type="text" id="edu" placeholder="请选择学历要求" name="need_xueli">
              <ul id="edus">
                <li>不限</li>
                <li>大专</li>
                <li>本科</li>
            ...
            <li>
              <h1>工作性质</h1>
              <input type="text" id="workstyle" placeholder="请选择工作性质" name="need_xingzhi"> 
              <ul id="workstyles">
                <li>全职</li>
                <li>兼职</li>
                <li>实习</li>
            ...
            <li>
              <h1>职位诱惑</h1>
              <input type="text" id="describe" placeholder="一句话描述该职位的吸引力（不超过20字）" name="need_youhuo">
            </li>
            
            <li>
              <h1>职位描述</h1>
              <textarea  id="" cols="65" rows="10" placeholder="分条描述工作职责......" name="need_miaoshu"></textarea>
            </li>
            <li>
              <h1>工作地址</h1>
              <input type="text" placeholder="请输入详细的工作地址" name="need_address">
            </li>
            <li>
              <input class="btn" type="submit" value="立即发布职位" style="margin-left: 165px;margin-top: 120px" >
            </li>
          </ul>
        </form>
      </div>
